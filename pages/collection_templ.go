...
func Collection(bids []models.Bid, token dto.Token, isLoggedIn bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<nav aria-label=\"breadcrumb\" class=\"breadcrumb-nav mb-3\"><div class=\"container\"><ol class=\"breadcrumb\"><li class=\"breadcrumb-item\"><a href=\"/\">Home</a></li><li class=\"breadcrumb-item active\" aria-current=\"page\">Collections</li></ol></div><!-- End .container --></nav><!-- End .breadcrumb-nav --> <div class=\"container\"><div class=\"page-header page-header-medium text-center\" style=\"background-image: url(&#39;assets/images/backgrounds/cta/bg-7.jpg&#39;)\"><h1 class=\"page-title text-white\">Collections<span class=\"text-white\">Bid List</span></h1></div><!-- End .page-header --></div><!-- End .container --> <br><div class=\"page-content\"><div class=\"container\"><table class=\"table table-wishlist table-mobile\"><thead><tr><th>Product</th><th>Your Bid</th><th>Highest Bid</th><th>Status</th><th></th></tr></thead> <tbody>")
			if templ_7745c5c3_Err != nil {
			...
			for _, bid := range bids {
				...
				templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Photo)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 49, Col: 72}
				}
				...
				templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Name)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 49, Col: 92}
				}
				...
				var templ_7745c5c3_Var5 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/item?id=%s", bid.Item.ID))
				...
				templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Name)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 54, Col: 123}
				}
				...
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Currency.Code)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 58, Col: 77}
				}
				...
				templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.2f", bid.Bid))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 58, Col: 107}
				}
				...
				templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Currency.Code)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 59, Col: 77}
				}
				...
				if bid.Item.Date.AddDate(0, 0, bid.Item.Duration).Before(time.Now()) {
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<i class=\"la la-history in-stock\" style=\"font-size: 2rem;\" alt=\"Ongoing\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "</td><td class=\"action-col\" style=\"min-width: 5px;\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				if bid.Item.Date.AddDate(0, 0, bid.Item.Duration).Before(time.Now()) {
					if bid.Item.Bids[0].UserID == token.UserID {
						if bid.Cart != nil {
							if bid.Cart.Payment != nil {
								if bid.Cart.Payment.Status != "O" {
									...
									var templ_7745c5c3_Var11 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/payment?id=%s", bid.Cart.Payment.ID))
									_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(string(templ_7745c5c3_Var11)))
									if templ_7745c5c3_Err != nil {
										return templ_7745c5c3_Err
									}
									templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "\"><span class=\"in-stock\">Waiting seller confirm</span></a>")
									if templ_7745c5c3_Err != nil {
										return templ_7745c5c3_Err
									}
								}
								...
								var templ_7745c5c3_Var12 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/checkout?cart_id=%s", bid.Cart.ID))
								_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(string(templ_7745c5c3_Var12)))
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
								templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "\"><button class=\"btn btn-block btn-outline-primary-2\"><i class=\"la la-shopping-cart\"></i>Checkout</button></a>")
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
							}
						} else {
							templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<span class=\"in-stock\">Waiting seller approve</span>")
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
						}
						...
						templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Bids[0].User.Name[0:1])
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 118, Col: 86}
						}
						...
						templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Repeat("*", len(strings.Split(bid.Item.Bids[0].User.Name, " ")[0])-1))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 118, Col: 164}
						}
						...
						if len(strings.Split(bid.Item.Bids[0].User.Name, " ")) > 1 {
							var templ_7745c5c3_Var15 string
							templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Split(bid.Item.Bids[0].User.Name, " ")[1][0:1])
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 120, Col: 106}
							}
							...
							templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Repeat("*", len(strings.Split(bid.Item.Bids[0].User.Name, " ")[1])-1))
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 120, Col: 184}
							}
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "<span class=\"in-stock\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					var templ_7745c5c3_Var17 string
					templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Date.Format("January, 02 2006"))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 124, Col: 104}
					}
					...
					templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(bid.Item.Date.AddDate(0, 0, bid.Item.Duration).Format("January, 02 2006"))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/collection.templ`, Line: 124, Col: 182}
					}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "</tbody></table><!-- End .table table-wishlist --></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
