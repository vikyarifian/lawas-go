...
func Offers(items []models.Item, token dto.Token, isLoggedIn bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<nav aria-label=\"breadcrumb\" class=\"breadcrumb-nav mb-3\"><div class=\"container\"><ol class=\"breadcrumb\"><li class=\"breadcrumb-item\"><a href=\"/\">Home</a></li><li class=\"breadcrumb-item active\" aria-current=\"page\">Offers</li></ol></div><!-- End .container --></nav><!-- End .breadcrumb-nav --> <div class=\"container\"><div class=\"page-header page-header-medium text-center\" style=\"background-image: url(&#39;assets/images/backgrounds/cta/bg-7.jpg&#39;)\"><h1 class=\"page-title text-white\">Offers<span class=\"text-white\">Item List</span></h1></div><!-- End .page-header --></div><!-- End .container --> <br><div class=\"page-content\"><div class=\"container\"><table class=\"table table-wishlist table-mobile\"><thead><tr><th>Product</th><th>Open Bid</th><th>Highest Bid</th><th>Status</th><th></th></tr></thead> <tbody>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, item := range items {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<tr><td class=\"product-col\"><div class=\"product\"><figure class=\"product-media\"><a href=\"#\"><img src=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 49, Col: 68}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 49, Col: 84}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\"></a></figure><h3 class=\"product-title\"><a href=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var5 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/item?id=%s", item.ID))
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 54, Col: 115}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var6))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "</a></h3><!-- End .product-title --></div><!-- End .product --></td><td class=\"price-col\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var7 string
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(item.Currency.Code)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 58, Col: 73}
				}
				...
				templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.2f", item.OpenBid))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 58, Col: 108}
				}
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var8))
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</td><td class=\"price-col\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				if item.Bids[0].Bid != 0 {
					var templ_7745c5c3_Var9 string
					templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(item.Currency.Code)
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 61, Col: 59}
					}
					...
					templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("%.2f", item.Bids[0].Bid))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 61, Col: 98}
					}
				...
				if item.Date.AddDate(0, 0, item.Duration).Before(time.Now()) {
					if item.Bids[0].Bid != 0 {
						...
						templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Repeat("*", len(strings.Split(item.Bids[0].User.Name, " ")[0])-1))
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 81, Col: 156}
						}
						...
						if len(strings.Split(item.Bids[0].User.Name, " ")) > 1 {
							var templ_7745c5c3_Var13 string
							templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Split(item.Bids[0].User.Name, " ")[1][0:1])
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 83, Col: 102}
							}
							...
							templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(strings.Repeat("*", len(strings.Split(item.Bids[0].User.Name, " ")[1])-1))
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 83, Col: 176}
							}
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<i class=\"la la-history in-stock\" style=\"font-size: 2rem;\" alt=\"Ongoing\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "</td><td class=\"action-col\" style=\"min-width: 5px;\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				if item.Date.AddDate(0, 0, item.Duration).Before(time.Now()) {
					if item.Bids[0].Bid != 0 {
						if item.Bids[0].Cart == nil {
							...
							templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "\" class=\"btn btn-block btn-outline-primary-2\" hx-disabled-elt=\"")
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
							...
							templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/approve-bid-bid?item_id=%s&bid_id=%s&user_id=%s&bid_no=%v", item.ID, item.Bids[0].ID, item.Bids[0].UserID, item.Bids[0].No))
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 99, Col: 194}
							}
							_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var17))
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
							templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "\" hx-swap=\"none\" hx-trigger=\"click\" hx-target-400=\"#error_approve\" hx-indicator=\".htmx-loader\"><i class=\"la la-thumbs-up\"></i>Approve Bid</button> <span id=\"")
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
							...
							templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "\"></span> <span id=\"")
							if templ_7745c5c3_Err != nil {
								return templ_7745c5c3_Err
							}
							...
							if item.Bids[0].Cart == nil && item.Bids[0].Cart.Payment == nil && item.Bids[0].Cart.Payment.Status == "O" {
								...
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 109, Col: 117}
								}
								_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var20))
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
								templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 22, "\" class=\"btn btn-block btn-outline-primary-2\" hx-disabled-elt=\"")
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
								...
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 110, Col: 127}
								}
								...
								templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/approve-pay-payment?item_id=%s&bid_id=%s&user_id=%s&bid_no=%v", item.ID, item.Bids[0].ID, item.Bids[0].UserID, item.Bids[0].No))
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 111, Col: 202}
								}
								_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var22))
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
								templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 24, "\" hx-swap=\"none\" hx-trigger=\"click\" hx-target-400=\"#error_approve\" hx-indicator=\".htmx-loader\"><i class=\"la la-thumbs-up\"></i>Approve Payment</button> <span id=\"")
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
								...
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 117, Col: 114}
								}
								...
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 118, Col: 116}
								}
								...
								templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "<span class=\"in-stock\">Waiting payment</span>")
								if templ_7745c5c3_Err != nil {
									return templ_7745c5c3_Err
								}
							}
						...
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "<i class=\"la la-times-circle\" style=\"color:#df4625;\"></i>")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					}
				} else {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "<span class=\"in-stock\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 129, Col: 100}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/offers.templ`, Line: 129, Col: 170}
					}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 33, "</tbody></table><!-- End .table table-wishlist --></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
